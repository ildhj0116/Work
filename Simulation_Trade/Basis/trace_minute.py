...
#设置多空合约以及手数、乘数
cnt_list_str = "MA805.CZC,C1805.DCE,ZC805.CZC,A1805.DCE,L1805.DCE,J1805.DCE,RB1805.SHF,Y1805.DCE,BU1806.SHF,JM1805.DCE"
cnt_list = cnt_list_str.split(',')
long_list = "MA805.CZC,C1805.DCE,ZC805.CZC,A1805.DCE,L1805.DCE".split(",")
short_list = "J1805.DCE,RB1805.SHF,Y1805.DCE,BU1806.SHF,JM1805.DCE".split(",")
cnt_size = [13,21,6,10,8,-2,-9,-6,-13,-5]
...
#设置起止时间
start_time = "2018-01-31 9:00:00"
end_time = "2018-01-31 15:01:00"
...
ax1.set_title(u"基差持仓多头总合约价值/空头总合约价值("+datetime.now().date().strftime("%Y-%m-%d")+")",fontsize=20)
#画图，设置图片大小及分辨率、保存
ax1.plot(x,y)
fig.set_dpi(100)
