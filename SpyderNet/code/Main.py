...
def Backtest_Main(strat_name,main_cnt,cmt_oi,total_oi,price_table,para_r=1,para_n=5,para_lambda=0,para_fee_rate=0):
    #产生指标
    index = Signal_Index_Generation_Main(strat_name,cmt_oi,total_vol_oi_df,para_r,para_n)
    #产生信号 
    ...
    return bktest_result,performance
...
if __name__ =="__main__":
    ...
    for cmt in effective_cmt_list:
        ...
        for para_lambda in para_lambda_list:            
            bk_result,perf = Backtest_Main(para_strat_name,main_cnt_df[cmt],cmt_oi,total_oi,price_table,para_r,para_n,para_lambda)
